-- 모든 테이블 삭제 (외래키 제약 조건 고려하여 역순으로 삭제)
DROP TABLE IF EXISTS lesson_chat;
DROP TABLE IF EXISTS lesson_enrollment;
DROP TABLE IF EXISTS lesson;
DROP TABLE IF EXISTS calendar_memo;
DROP TABLE IF EXISTS calendar_exercise;
DROP TABLE IF EXISTS calendar_food;
DROP TABLE IF EXISTS comment;
DROP TABLE IF EXISTS board;
DROP TABLE IF EXISTS category;
DROP TABLE IF EXISTS MemberToMaster;
DROP TABLE IF EXISTS member;
DROP TABLE IF EXISTS GraphAverage;
DROP TABLE IF EXISTS Data_Exercise;
DROP TABLE IF EXISTS Data_Food;
DROP TABLE IF EXISTS Data_Gym;
